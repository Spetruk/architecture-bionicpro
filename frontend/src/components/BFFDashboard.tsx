    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          {userInfo.roles.includes('prosthetic-pilot') && (
